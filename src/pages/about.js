				...
				<div className="grid-two">	
					...
					<ul>
						<li>
							...
							<p>Responsible for supervising a 170,000 sq. ft. superstore in store directors' absence. Supervise and direct front-end employee activities, protect substantial cash assets, and work mandatory overtime as needed. Ensure maintenance and operability of check-out technology including self-checkout robots and cash recycler. Also trained in grocery inventory ordering and stocking as well as selection and curbside delivery of online pickup orders.</p>	
						</li>
						<li>
							<h3 className="dark-header">Red Pepper Software - Software Development Intern</h3>
							<p>Jan 2019 - Nov 2019</p>
							<p>Using Jira as the productivity tool inline with scrum methodology and agile workflow, assisted team with QA, pair programming, code review and full stack coding assignments building proprietary software for multiple clients. While managing multiple tickets on strict tempo timers, switched between different tech stacks and languages throughout the day. Worked in frontend web and mobile development using HTML, CSS, Sass, JavaScript, TypeScript, PHP,  Razor, Xamarin.iOS, amd JS frameworks such as Angular. Customized templates on e-commerce platforms such as Shopify and blog-sites such as WordPress and Magento. Interfaced with CRM APIs such as Zoho. Also worked in backend development using C#, ASP.NET, Entity framework and SQL. Managed version control using git with code bases in Github and Bitbucket. Also conducted lunch & learns and speed training sessions for company staff.</p>	
						</li>
						<li>
							<h3 className="dark-header">Flynn Restaurant Group - Applebee's Assistant Manager</h3>
							<p>Jan 2016 - Nov 2016</p>
							<p>Trained to oversee every aspect of a full service casual dining restaurant. Singlehandedly ran the restaurant while supervising up to 30 people per shift. Included learning, and performing with proficiency, every single position in the front and back of house. Managerial duties included daily/weekly  inventory, supply orders, interviewing, hiring, training, and promoting special marketing events.</p>	
						</li>
						<li>
						...
						<li>
							...
							<p>Former Assistant to the Director of the Center for Engineering Innovation in the Dept. of Electrical & Computer Engineering and Nanotechnology Institute of Utah. Coordinated the design and development of websites, social media, and marketing materials for the center. Provided support to research faculty, visiting scholars, guest speakers and staff by arranging meetings and travel. Organized special events and conferences including venue selection, catering, promotion, sponsorship, media materials and event set-up. Certified to oversee proposal preparation and post-award management of grants and contracts. Coordinated project and customer resource management using CRM tools such as Pipedrive and Zoho.</p>	
						</li>
					</ul>
				</div>
