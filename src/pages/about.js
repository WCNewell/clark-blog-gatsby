		...
		<Seo title='About' />
			<main className="main-grid">
				...
				<div className="grid-one">
					...
					<h2>Goal</h2>
					<p>To serve your software company as a problem solving Junior Developer or Project Manager who uplifts his team and delights clients. <strong><a alt="link to download pdf resume" href={downLoadFile} download>Download My Resume.</a></strong></p>
